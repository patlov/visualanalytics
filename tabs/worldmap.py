...
def update_map(value_type, refresh=False):
    ...
    if sensors_from_web is None or refresh is True:
        ...
        sensor_df = pd.json_normalize(sensors_from_web, record_path='sensordatavalues', meta=['timestamp', 'location'])
    ...
    fig = px.density_mapbox(typed_sensor_df, hover_name='value_type', lat="latitude", lon="longitude", z='value',
                            zoom=2,
                            height=850)
